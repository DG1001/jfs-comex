...
- `ghcr.io/dg1001/jfs-comex:1.0.3` — feste Version, **für Prod empfohlen**
...
services:
  comex:
    image: ghcr.io/dg1001/jfs-comex:1.0.3
...
Bei gepinntem `:1.0.3` den Tag in der `compose.yml` auf die neue Version setzen.
